  ...
  return (
    <Layout title="Profile">
      ...
      >
        ...
        <div className="mb-4">
          ...
          <input
            ...
            {...register('password', {
              ...
              minLength: { value: 6, message: 'La contraseña debe tener más de 5 caracteres' },
            })}
          />
          {errors.password && (
        ...
        <div className="mb-4">
          ...
          <input
            ...
            {...register('confirmPassword', {
              required: 'Porfavor confirma tu contraseña',
        ...
        <div className="mb-4">
          <button className="primary-button">Actualizar</button>
        </div>
      </form>
    </Layout>
  );
